...
urlpatterns = [
    ...
    path('search-income', csrf_exempt(views.search_income),
         name="search_income"),
    path('income_description_summary', views.income_description_summary, name="income_description_summary"),
    path('stats-income', views.stats_viewer, name="stats-income")
